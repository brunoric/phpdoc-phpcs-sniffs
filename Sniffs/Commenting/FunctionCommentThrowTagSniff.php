 ...
 * @author    Greg Sherwood <gsherwood@PHPDoc.net>
 * @author    Marc McIntyre <mmcintyre@PHPDoc.net>
 * @author    Daniele Scasciafratte <daniele@codeat.it>
 * @copyright 2006-2014 PHPDoc Pty Ltd (ABN 77 084 670 600)
 * @license   https://github.com/PHPDoclabs/PHP_CodeSniffer/blob/master/licence.txt BSD Licence
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PHPDoc_Sniffs_Commenting_FunctionCommentThrowTagSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{


    /**
     * Constructs a PHPDoc_Sniffs_Commenting_FunctionCommentThrowTagSniff.
     */
